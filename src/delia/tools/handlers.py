...
def register_tool_handlers(mcp: FastMCP):
    ...
    async def auto_context(
        ...
        # =================================================================
        # These recommendations guide LLMs to use the right tools for each task.
        # Tools are grouped by category and task type for optimal discovery.

        # Memory tools - useful for ALL tasks (persist knowledge across sessions)
        MEMORY_TOOLS = [
        ...
        # Add core file tools (useful for most tasks)
        recommended_tools.extend(FILE_TOOLS)

        # Add framework workflow tools (ensure Delia methodology)
        recommended_tools.extend(FRAMEWORK_TOOLS)

        # Add memory tools (persist knowledge across sessions)
