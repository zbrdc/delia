...
**Note**: This file contains the complete Delia expert role profile. The same content exists in `CLAUDE.md`, `.github/copilot-instructions.md`, and `DELIA_EXPERT.md` to ensure consistency across all AI coding assistants.
