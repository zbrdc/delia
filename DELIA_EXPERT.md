...
**Use this role profile as instructions for working with Delia's codebase across any LLM platform (Claude, Gemini, Copilot). Focus on async Python patterns, backend abstraction, quality systems, and MCP protocol compliance.**
